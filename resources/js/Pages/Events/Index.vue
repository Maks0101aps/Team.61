          ...
          <div>
            ...
            <div class="mt-2 space-y-1">
              ...
              <div v-if="event.online_link" class="flex items-center text-sm">
                ...
                <a :href="event.online_link" target="_blank" class="text-amber-600 hover:text-amber-800 transition-colors duration-200">
      ...
      <table class="w-full">
        <thead>
          <tr class="bg-gradient-to-r from-amber-50 to-amber-100 text-left">
            ...
            <th class="py-4 px-6 font-bold text-amber-900">{{ language === 'uk' ? 'Тип' : 'Type' }}</th>
            <th class="py-4 px-6 font-bold text-amber-900">{{ language === 'uk' ? 'Дата початку' : 'Start Date' }}</th>
            <th class="py-4 px-6 font-bold text-amber-900">{{ language === 'uk' ? 'Тривалість' : 'Duration' }}</th>
            <th class="py-4 px-6 font-bold text-amber-900">{{ language === 'uk' ? 'Місце' : 'Location' }}</th>
            <th class="py-4 px-6 font-bold text-amber-900">{{ language === 'uk' ? 'Створив' : 'Created By' }}</th>
            <th class="py-4 px-6 font-bold text-amber-900">{{ language === 'uk' ? 'Посилання' : 'Link' }}</th>
