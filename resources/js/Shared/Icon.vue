<template>
  ...
  <svg v-else-if="name === 'calendar'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M1 4c0-1.1.9-2 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V4zm2 2v12h14V6H3zm2-6h2v2H5V0zm8 0h2v2h-2V0zM5 9h2v2H5V9zm0 4h2v2H5v-2zm4-4h2v2H9V9zm0 4h2v2H9v-2zm4-4h2v2h-2V9zm0 4h2v2h-2v-2z" /></svg>
  <svg v-else-if="name === 'list'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M1 4h2v2H1V4zm4 0h14v2H5V4zM1 9h2v2H1V9zm4 0h14v2H5V9zm-4 5h2v2H1v-2zm4 0h14v2H5v-2z"/></svg>
  ...
  <svg v-else-if="name === 'book-open'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10.2 1.44c.2-.1.5-.1.8 0 3.77 1.33 5.8 2.73 6.04 4.2.06.41.06.82 0 1.23-.23 1.47-2.26 2.87-6.03 4.2-.3.1-.6.1-.9 0C6.32 9.74 4.3 8.34 4.06 6.87c-.06-.41-.06-.82 0-1.23.23-1.47 2.26-2.87 6.03-4.2h.1zM3 8.99v8.02c0 1.1.9 2 2 2h10a2 2 0 0 0 2-2V8.98c-1.61 1.2-3.85 2.23-6.4 2.92-.74.2-1.5.2-2.23 0-2.53-.7-4.77-1.71-6.37-2.9zm2.5-5.5c-.5 0-1 .4-1 1s.4 1 1 1 1-.4 1-1-.4-1-1-1z"/></svg>
  <svg v-else-if="name === 'user-group'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M7 8a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm0 1c2.15 0 4.2.4 6.1 1.09L12 16h-1.25L10 20H4l-.75-4H2L.9 10.09A17.93 17.93 0 0 1 7 9zm8.31.17c1.32.18 2.59.48 3.8.92L18 16h-1.25L16 20h-3.96l.37-2h1.25l1.65-8.83zM13 0a4 4 0 1 1-1.33 7.76 5.96 5.96 0 0 0 0-7.52C12.1.1 12.53 0 13 0z"/></svg>
  <svg v-else-if="name === 'teacher'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10 1L2 6l8 5 8-5-8-5zM8 12.5L3 9.5v4.9c0 .65.5 1.2 1.15 1.2h11.7c.65 0 1.15-.55 1.15-1.2V9.5l-5 3v2c0 .55-.45 1-1 1h-2c-.55 0-1-.45-1-1v-2z"/></svg>
</template>
